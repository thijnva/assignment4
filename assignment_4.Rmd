...
title: | 
  ...
  | 2022-2023
author: |
  | Thijn van Amersfoort
  | t.l.vanamersfoort@students.uu.nl
  | http://www.github.com/thijnva
date: April 2023
urlcolor: purple
linkcolor: purple
output: 
...
datasummary(Mean + Median + SD + Min + Max ~ treat * (growth + rgdp60),
            data = GrowthSW)
```
...
The p-value is 0.06781. Meaning that if the difference in means between the group with 0 revolutions and the group with more than 0 revolutions is not equal to 0 (the null hypothesis) is true, than there is a 6.781% chance of obtaining a test statistic as the one observed. 
...
The rgdp60 is the value of GDP per capita in 1960, converted to 1960 US dollars. This deals with the different currencies used in every country, because when comparing countries you need to look at the economic conditions of each country relative to a common currency. It also helps to see if the starting economical conditions influence the observed differences in growth rates between countries with revolutions or without revolutions. 
...
The tradeshare is the highest coefficient, indicating that an increase in trade share has a positive effect on the economic growth. This suggest that countries who tend to trade more with other countries have a higher level of economic growth. 
